defmodule AOC.Day15.Part2 do
  ...
  def process([
        {name1, capacity1, durability1, flavor1, texture1, calories1},
        {name2, capacity2, durability2, flavor2, texture2, calories2},
        {name3, capacity3, durability3, flavor3, texture3, calories3},
        {name4, capacity4, durability4, flavor4, texture4, calories4}
      ]) do
    for i <- 1..97, j <- 1..97, k <- 1..97, l <- 1..97, i + j + k + l == 100 do
      calories = i * calories1 + j * calories2 + k * calories3 + l * calories4
  ...
  def process_example([
    ...
    for i <- 1..97, j <- 1..97, i + j == 100 do
      calories = i * calories1 + j * calories2
